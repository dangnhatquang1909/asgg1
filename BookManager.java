...
public class BookManager {
    ...
    public void loadFromFile() {
        ...
        try {
            ...
            //scanner.close(); // Will occur an error!
...
//        PLAGIARISM!!
        while (scanner.hasNextLine()) {
            ...
            int id = Integer.parseInt(text.substring(0, 5).trim());
            String name = text.substring(6, 51).trim();
            double price = Double.parseDouble(text.substring(51).trim());

            totalBooks.add(new Book(id, name, price));
        }
    }
    ...
    public void saveToFile() {
        try {
            FileOutputStream fos = new FileOutputStream(new File("books.txt"));
